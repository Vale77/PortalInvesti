...
public abstract class AbstractFacade<T> {
    ...
    public void sendEmail(String profile_name, String recipients, String copy_recipients, String blind_copy_recipients, String psubject, String pmensaje, String body_format) {
        Query query = getEntityManager().createNativeQuery("{call msdb.dbo.sp_send_dbmail(?,?,?,?,?,?,?)}");
